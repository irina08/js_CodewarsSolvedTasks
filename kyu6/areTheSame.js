...
multiplicities. "Same" means, here, that the elements in b are the elements in a squared,
...
function comp(array1, array2){
  ...
  array2 = array2
    .sort((a, b) => a - b)
    .map((el, i) => el === array1[i] ** 2);
  return array2.length === 0 ? true : array2.reduce((a, b) => a && b);
}