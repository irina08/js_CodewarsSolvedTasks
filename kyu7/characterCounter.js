...
that each character in that word has the exact same number of
occurrences. You will return true if it is valid, or false if it is not.
...
"123abc!" is a valid word because all of the characters only appear
once in the word.
