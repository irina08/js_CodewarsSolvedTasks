...
The goal of the game is to fill all cells of the grid with digits
from 1 to 9, so that each column, each row, and each of the nine 3x3
...
invalid solutions. The board is always 9 cells by 9 cells, and every cell only
