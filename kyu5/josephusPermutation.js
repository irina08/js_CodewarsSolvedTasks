/* This problem takes its name by arguably the most important event in the
life of the ancient historian Josephus: according to his tale, he and his
...
Well, Josephus and another man were the last two and, as we now know every detail of
...
parameters the initial array/list of items to be permuted as if they were in
a circle and counted out every k places until none remained.
...
function josephus(items,k){
  let result = [], n = items.length, index = 0;
