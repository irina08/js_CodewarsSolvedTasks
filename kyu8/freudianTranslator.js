...
"The Hitchhiker's Guide to the Galaxy". For Freud, the answer
was quite different.
...
society was at the time. Freud then wanted to study the illnesses
created by this, and so he digged to the root of their desires.
...
for Freud, everything was basically related to, and explained by sex.
...
function toFreud(string) {
  ...
  if(!string || string === "")
    return "";
  result = string.split(' ');
  return result.map(el => el = "sex").join(' ');
}